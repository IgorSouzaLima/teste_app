  ...
  return (
    <Layout title="Veículos">
      <div className="page-toolbar">
        <div>
          <div className="card-title" style={{ marginBottom: 4 }}>Frota disponível</div>
          <div className="card-subtitle">Cadastre os veículos que podem ser vinculados às próximas viagens sem afetar os dados antigos.</div>
        </div>
